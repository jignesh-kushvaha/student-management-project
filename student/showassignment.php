...
<head>
    ...
    <?php
        ...
        {
            $assignmentid=$_POST['btndownload'];	
            $query="select image from assignment where assignmentid='$assignmentid'";
            $rw=$dc->getRow($query);
            $filename=$rw['image'];
            $filepath="../assignmentfile/".$filename;
                     ...
                     <div class="form-group col-md-6">
                      ...
                      <table class="table table-bordered table-striped">
                       ...
                       <?php   
                            ...
                            $query="select n.assignmentid,s.subname,image from assignment n,subject s where n.subid =$subid and s.subid=$subid";
                            ...
                            while($rw=mysqli_fetch_array($tb))
                            {
                                ...
                                echo("<td>" . $rw['image'] . "</td>");
                                echo("<td> <button name='btndownload' class='btn btn-gradient-primary me-2' value='".$rw['assignmentid']."'>Download</buuton></td>");
                                echo("</tr>");
                            }
                        }
                       ?>
