...
<head>
  ...
  <?php 
      ...
      if(isset($_POST['btnsend']))
      {
          ...
          $query="insert into email(emaildate,emailto,subject,description,regid) values('$emaildate','$emailto','$subject','$description','$teachid')";
  ...
  ?>
   ...
   <?php 	
	...
	{
	   header('location:emailfaculty.php');
	}	
  ?>
